...
pub fn builtin_policy_commit_for_token(token_id: &str) -> Option<[u8; 32]> {
    ...
    match token_id {
        ...
        "dBTC" => Some([
            0x03, 0xa4, 0x2b, 0x67, 0x19, 0x17, 0xaf, 0x84,
            0x2f, 0x07, 0x3d, 0x87, 0xcf, 0xa4, 0x59, 0xd8,
            0x45, 0xb9, 0x68, 0xfd, 0xb1, 0xab, 0xcb, 0x03,
            0x31, 0x2d, 0x91, 0x4e, 0x35, 0x01, 0x62, 0x22,
        ]),
        _ => None,
    }
}
